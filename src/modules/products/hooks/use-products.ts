...
export function useProducts(params: { page: number; limit: number; search?: string }) { return useQuery({ queryKey: ["products", params], queryFn: () => productsService.list(params) }); }
