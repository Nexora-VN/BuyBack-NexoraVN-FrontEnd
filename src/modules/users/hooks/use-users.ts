...
export function useUsers(params: { page: number; limit: number; sort?: 'asc' | 'desc'; status?: 'ACTIVE' | 'DISABLED'; search?: string }) { return useQuery({ queryKey: ["users", params], queryFn: () => usersService.list(params) }); }
