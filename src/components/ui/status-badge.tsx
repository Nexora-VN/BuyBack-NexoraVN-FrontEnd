...
export type StatusDomain='general'|'order'|'commission'|'cashback'|'withdrawal'|'bank'|'batch'|'issue'|'settlement';
...
const contextual:Partial<Record<StatusDomain,Record<string,string>>>={order:{VALIDATED:'Hoàn thành',REJECTED:'Đã hủy / Không hợp lệ'},commission:{VALIDATED:'Hoa hồng đã xác thực',PAID:'Đã quyết toán'},cashback:{PENDING:'Chờ xác nhận',VALIDATED:'Chờ quyết toán',AVAILABLE:'Có thể rút'},withdrawal:{PENDING:'Chờ xử lý',COMPLETED:'Đã chuyển tiền',FAILED:'Chuyển thất bại'},bank:{PENDING:'Chờ duyệt',APPROVED:'Đã duyệt'}};
